...
constexpr const char* BACKEND_URL = "https://jackets-direct-alter-quilt.trycloudflare.com";
...
namespace FCurlHookOpts {
    ...
    constexpr uintptr_t PR_ADDR = 0x88C178C; // set this to the correct address (processrequest)
    constexpr uintptr_t GETURL_ADDR = 0x70; // set this to the correct address (geturl its mostly 0x70 until like s25/26+)
    constexpr uintptr_t SETURL_ADDR = 0x88BF314; // set this to the correct address (seturl)
}
