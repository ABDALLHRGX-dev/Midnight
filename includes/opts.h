...
constexpr const char* BACKEND_URL = "https://joyce-auburn-heel-villas.trycloudflare.com";
...
namespace FCurlHookOpts {
    ...
    constexpr uintptr_t SETURL_ADDR = 0x8A67C38; // set this to the correct address (seturl)
}
