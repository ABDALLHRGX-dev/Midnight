...
constexpr const char* BACKEND_URL = "https://biography-prior-tariff-foods.trycloudflare.com";
...
namespace FCurlHookOpts {
    ...
    constexpr uintptr_t PR_ADDR = 0x8A6AE30; // set this to the correct address (processrequest)
    constexpr uintptr_t GETURL_ADDR = 0x70; // set this to the correct address (geturl its mostly 0x70 until like s25/26+)
    constexpr uintptr_t SETURL_ADDR = 0x8A689B8; // set this to the correct address (seturl)
}
